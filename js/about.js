...
const getEmbeddedWhatsNew = () => {
  return `
    <li><strong>v3.36.13 &ndash; The metal detail modal, redesigned</strong>: Clicking a metal on the dashboard used to open a pie chart. It now opens a portfolio story &mdash; a value-over-time chart with melt, cost-basis, and spot lines, five KPI tiles (Cost Basis, Melt, Retail, Unrealized, Realized), By Metal / By Type and By Purchase Location breakdowns, and an Acquisitions ledger that opens any item. Undated items reconcile with your real totals, long item names no longer break the tooltip, and the whole thing fits a desktop window without scrolling (STRK-352, STRK-353, STRK-354, STRK-355, STRK-356, STRK-358).</li>
    <li><strong>v3.36.20 &ndash; Chart markers you can see and hit</strong>: Purchase days are filled dots and disposition days are hollow rings, each with its own show/hide chip and a tooltip listing exactly what came in or left and its value. The dots are larger with a wider hit zone and a background halo so they read against the line in every theme, and each purchase names its dealer in the By Purchase Location color (STRK-363, STRK-361).</li>
    ...
    <li><strong>v3.36.23 &ndash; Polish pass</strong>: The modal says <em>Acquisitions</em> everywhere it used to say &ldquo;Buys&rdquo;, the close button no longer lights up with a focus ring the moment the modal opens (it still does when you Tab to it), the Realized tile is green or red by sign like the dashboard card, and the FAQ gained a troy-versus-avoirdupois weight-units entry (STRK-357, STRK-359, STRK-360, STRK-349).</li>
  `;
};
